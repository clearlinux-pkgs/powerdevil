...
Source0  : https://download.kde.org/stable/plasma/6.3.5/powerdevil-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/powerdevil-6.3.5.tar.xz.sig
...
%setup -q -n powerdevil-6.3.5
cd %{_builddir}/powerdevil-6.3.5
%patch -P 1 -p1
pushd ..
cp -a powerdevil-6.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747236687
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/powerdevil-%{version}/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/powerdevil/52039e5c19c950d4c7d6ec5da42ebba2c6def7ee || :
...
cp %{_builddir}/powerdevil-%{version}/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/powerdevil/d731920113454e58292b53feedd262e531cae0f1 || :
...
cp %{_builddir}/powerdevil-%{version}/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/powerdevil/e458941548e0864907e654fa2e192844ae90fc32 || :
cp %{_builddir}/powerdevil-%{version}/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/powerdevil/adadb67a9875aeeac285309f1eab6e47d9ee08a7 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpowerdevilcore.so.6.3.5
...
/V3/usr/lib64/qt6/plugins/powerdevil/action/powerdevil_screenbrightnesscontrolaction.so
...
/usr/lib64/libpowerdevilcore.so.6.3.5
...
/usr/lib64/qt6/plugins/powerdevil/action/powerdevil_screenbrightnesscontrolaction.so
...
/usr/share/package-licenses/powerdevil/52039e5c19c950d4c7d6ec5da42ebba2c6def7ee
...
/usr/share/package-licenses/powerdevil/adadb67a9875aeeac285309f1eab6e47d9ee08a7
/usr/share/package-licenses/powerdevil/d731920113454e58292b53feedd262e531cae0f1
...
%files locales -f kcm_powerdevilprofilesconfig.lang -f plasma_applet_org.kde.plasma.battery.lang -f plasma_applet_org.kde.plasma.brightness.lang -f plasma_runner_powerdevil.lang -f powerdevil.lang
%defattr(-,root,root,-)
