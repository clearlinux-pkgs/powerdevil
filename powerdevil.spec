...
%setup -q -n powerdevil-6.2.5
cd %{_builddir}/powerdevil-6.2.5
%patch -P 1 -p1
pushd ..
cp -a powerdevil-6.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736201184
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpowerdevilconfigcommonprivate.so.6.2.5
/V3/usr/lib64/libpowerdevilcore.so.6.2.5
...
/usr/lib64/libpowerdevilconfigcommonprivate.so.6.2.5
/usr/lib64/libpowerdevilcore.so.2
/usr/lib64/libpowerdevilcore.so.6.2.5
