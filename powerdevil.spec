...
Version  : 6.3.4
Release  : 108
URL      : https://download.kde.org/stable/plasma/6.3.4/powerdevil-6.3.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.4/powerdevil-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/powerdevil-6.3.4.tar.xz.sig
...
%setup -q -n powerdevil-6.3.4
cd %{_builddir}/powerdevil-6.3.4
%patch -P 1 -p1
pushd ..
cp -a powerdevil-6.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744158380
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpowerdevilcore.so.6.3.4
...
/usr/lib64/libpowerdevilcore.so.6.3.4
