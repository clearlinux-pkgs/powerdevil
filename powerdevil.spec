...
Version  : 5.27.3
Release  : 73
URL      : https://download.kde.org/stable/plasma/5.27.3/powerdevil-5.27.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.3/powerdevil-5.27.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.3/powerdevil-5.27.3.tar.xz.sig
...
%prep
%setup -q -n powerdevil-5.27.3
cd %{_builddir}/powerdevil-5.27.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679531183
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libpowerdevilconfigcommonprivate.so.5.27.3
/usr/lib64/libpowerdevilcore.so.2
/usr/lib64/libpowerdevilcore.so.5.27.3
/usr/lib64/libpowerdevilui.so.5
/usr/lib64/libpowerdevilui.so.5.27.3
