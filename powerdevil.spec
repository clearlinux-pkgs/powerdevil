...
Source0  : https://download.kde.org/stable/plasma/6.2.0/powerdevil-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/powerdevil-6.2.0.tar.xz.sig
...
%setup -q -n powerdevil-6.2.0
cd %{_builddir}/powerdevil-6.2.0
%patch -P 1 -p1
pushd ..
cp -a powerdevil-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728927046
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpowerdevilconfigcommonprivate.so.6.2.0
/V3/usr/lib64/libpowerdevilcore.so.6.2.0
...
/usr/lib64/libpowerdevilconfigcommonprivate.so.6.2.0
/usr/lib64/libpowerdevilcore.so.2
/usr/lib64/libpowerdevilcore.so.6.2.0
...
%files locales -f kcm_powerdevilprofilesconfig.lang -f libpowerdevilcommonconfig.lang -f plasma_applet_org.kde.plasma.battery.lang -f plasma_applet_org.kde.plasma.brightness.lang -f plasma_runner_powerdevil.lang -f powerdevil.lang
%defattr(-,root,root,-)
