...
%prep
%setup -q -n powerdevil-6.0.2
cd %{_builddir}/powerdevil-6.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710370926
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpowerdevilconfigcommonprivate.so.6.0.2
/V3/usr/lib64/libpowerdevilcore.so.6.0.2
...
/usr/lib64/libpowerdevilconfigcommonprivate.so.6.0.2
/usr/lib64/libpowerdevilcore.so.2
/usr/lib64/libpowerdevilcore.so.6.0.2
