...
Version  : 6.3.2
Release  : 106
URL      : https://download.kde.org/stable/plasma/6.3.2/powerdevil-6.3.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.2/powerdevil-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/powerdevil-6.3.2.tar.xz.sig
...
%setup -q -n powerdevil-6.3.2
cd %{_builddir}/powerdevil-6.3.2
%patch -P 1 -p1
pushd ..
cp -a powerdevil-6.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741237232
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpowerdevilcore.so.6.3.2
...
/usr/lib64/libpowerdevilcore.so.6.3.2
