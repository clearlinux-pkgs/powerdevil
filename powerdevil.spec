...
Version  : 5.25.4
Release  : 61
URL      : https://download.kde.org/stable/plasma/5.25.4/powerdevil-5.25.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.25.4/powerdevil-5.25.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.4/powerdevil-5.25.4.tar.xz.sig
...
%prep
%setup -q -n powerdevil-5.25.4
cd %{_builddir}/powerdevil-5.25.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659717735
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libpowerdevilconfigcommonprivate.so.5.25.4
/usr/lib64/libpowerdevilcore.so.2
/usr/lib64/libpowerdevilcore.so.5.25.4
/usr/lib64/libpowerdevilui.so.5
/usr/lib64/libpowerdevilui.so.5.25.4
