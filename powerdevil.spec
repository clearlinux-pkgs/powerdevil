...
Version  : 5.23.2
Release  : 46
URL      : https://download.kde.org/stable/plasma/5.23.2/powerdevil-5.23.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.2/powerdevil-5.23.2.tar.xz
...
%prep
%setup -q -n powerdevil-5.23.2
cd %{_builddir}/powerdevil-5.23.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635362559
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/powerdevil-5.23.2/COPYING %{buildroot}/usr/share/package-licenses/powerdevil/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
...
/usr/lib64/libpowerdevilconfigcommonprivate.so.5.23.2
/usr/lib64/libpowerdevilcore.so.2
/usr/lib64/libpowerdevilcore.so.5.23.2
/usr/lib64/libpowerdevilui.so.5
/usr/lib64/libpowerdevilui.so.5.23.2
