...
Version  : 6.1.1
Release  : 93
URL      : https://download.kde.org/stable/plasma/6.1.1/powerdevil-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/powerdevil-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/powerdevil-6.1.1.tar.xz.sig
...
%setup -q -n powerdevil-6.1.1
cd %{_builddir}/powerdevil-6.1.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719436882
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpowerdevilconfigcommonprivate.so.6.1.1
/V3/usr/lib64/libpowerdevilcore.so.6.1.1
...
/usr/lib64/libpowerdevilconfigcommonprivate.so.6.1.1
/usr/lib64/libpowerdevilcore.so.2
/usr/lib64/libpowerdevilcore.so.6.1.1
