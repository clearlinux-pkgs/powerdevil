...
Version  : 5.23.4
Release  : 48
URL      : https://download.kde.org/stable/plasma/5.23.4/powerdevil-5.23.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.4/powerdevil-5.23.4.tar.xz
...
%prep
%setup -q -n powerdevil-5.23.4
cd %{_builddir}/powerdevil-5.23.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638365429
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/powerdevil-5.23.4/COPYING %{buildroot}/usr/share/package-licenses/powerdevil/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
...
/usr/lib64/libpowerdevilconfigcommonprivate.so.5.23.4
/usr/lib64/libpowerdevilcore.so.2
/usr/lib64/libpowerdevilcore.so.5.23.4
/usr/lib64/libpowerdevilui.so.5
/usr/lib64/libpowerdevilui.so.5.23.4
