...
Source0  : https://download.kde.org/stable/plasma/6.0.3/powerdevil-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/powerdevil-6.0.3.tar.xz.sig
...
%prep
%setup -q -n powerdevil-6.0.3
cd %{_builddir}/powerdevil-6.0.3
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711730375
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpowerdevilconfigcommonprivate.so.6.0.3
/V3/usr/lib64/libpowerdevilcore.so.6.0.3
...
/usr/lib64/libpowerdevilconfigcommonprivate.so.6.0.3
/usr/lib64/libpowerdevilcore.so.2
/usr/lib64/libpowerdevilcore.so.6.0.3
